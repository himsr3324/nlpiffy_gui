...
#TAB FOR NLPIFFY
label1 = Label(tab1,text='Sentimental Analysis via NLP',padx=5,pady=5)
...
#BUTTONS
button1 = Button(tab1,text='Tokenize',width=12,bg='sky blue',fg='white',command=get_tokens)
button1.grid(row=4,column=0,padx=10,pady=10)

button2 = Button(tab1,text='POS Tagger',width=12,bg='violet',fg='white',command=get_pos_tags)
button2.grid(row=4,column=1,padx=10,pady=10)

button3 = Button(tab1,text='Sentiment',width=12,bg='green',fg='white',command=get_sentiment)
button3.grid(row=4,column=2,padx=10,pady=10)

button4 = Button(tab1,text='Entities',width=12,bg='dark blue',fg='white',command=get_entities)
button4.grid(row=5,column=0,padx=10,pady=10)

button5 = Button(tab1,text='Reset',width=12,bg='red',fg='white',command=clear_entry_text)
button5.grid(row=5,column=1,padx=10,pady=10)

button6 = Button(tab1,text='Clear Result',width=12,bg='grey',fg='white',command=clear_display_result)
...
#Functions for Tab 2 File Processing
...
displayed_file.grid(row=2,column=0, columnspan=6,padx=5,pady=3)
...
tab2_display_text = ScrolledText(tab2,height=20)
...
about_label = Label(tab3,text="Sentimental Analysis GUI V 1.0 by:\n \n Aman Kumar\n Anirudh Pasari\n Aseem Prakash\n Himanshu Srivastava \n \n Under Guidence of :\n\n Professor Sudhakar K.N.\n\n CMR INSTITUTE OF TECHNOLOGY, BENGALURU. " ,pady=5,padx=5)
